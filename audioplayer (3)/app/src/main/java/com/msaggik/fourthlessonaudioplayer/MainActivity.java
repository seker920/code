...
public class MainActivity extends AppCompatActivity implements MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener {
    ...
    private final String DATA_STREAM = "https://biffhard.top/track/12908027991886245235-sematary_slaughter_house/https://biffhard.top/track/12908027991886245235-sematary_slaughter_house/"; // ссылка на аудио поток
        ...
        try {
            switch (view.getId()) {
                case R.id.btnStream:
                    ...
                    break;
                case R.id.btnRAW:
                    toast = Toast.makeText(this, "Запущен аудиофайл с памяти телефона", Toast.LENGTH_SHORT);
                    toast.show();
                    mediaPlayer = MediaPlayer.create(this, R.raw.flight_of_the_bumblebee);
                    mediaPlayer.start();
                    nameAudio = "Sematary - Slaughterhouse";
                    break;
                case R.id.btnSD:
